...
) : RecyclerView.Adapter<ProfileBookListAdapter.ViewHolder>()
{
    ...
    override fun onCreateViewHolder (parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        var columnView =  inflater.inflate(R.layout.booklist_3, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        userViewModel.getUserById(book.author) { user ->
            author.setText(user.penname);
        }
